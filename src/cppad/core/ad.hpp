...
# include "core/identical.hpp"

// define the template classes that are used by the AD template class
# include "local/op_code.hpp"
# include "local/recorder.hpp"
# include "local/player.hpp"
# include "local/ad_tape.hpp"
